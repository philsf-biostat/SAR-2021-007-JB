...
tab_desc %>%
  as_kable(
    align = "lccc",
    caption = "**Table 1** Geographical characteristics in ten urban planning areas (UPA) in Americana/SP (1998-2008)."
  )
```

```{r fig1, fig.cap="**Figure 1** Distribution density of geographical characteristics in ten urban planning areas (UPA) in Americana/SP (1998-2008)."}
